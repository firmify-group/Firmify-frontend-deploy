						...
						>
							<td colSpan={5} className="p-0">
								<div className="flex rounded-t-lg  border-b-[1.5px] border-font-400 overflow-hidden **:font-medium h-10">
									<td className="body-3 text-font-1000 w-1/12 pl-5 text-left py-2 bg-transparent">
										{product.id}
									</td>
									<td className="body-3 text-font-1000 w-3/12 pl-3 text-left py-2 bg-transparent">
										{product.name}
									</td>
									<td className="body-3 text-font-1000 w-3/12 pl-3 text-left py-2 bg-transparent">
										{product.rut}
